...
export class AppComponent implements OnInit, AfterViewInit{
  ...
  ngAfterViewInit(): void {
    ...
    document.querySelectorAll('div').forEach(section => observer.observe(section));
  ...
  enviarMail() {
    if (this.name && this.email && this.title && this.message) {
      ...
      emailjs.sendForm(environment.SERVICE_ID, environment.TEMPLATE_ID, form, environment.USER_ID)
        .then((response) => {
